...
(custom-set-variables
 ...
 '(package-selected-packages
   '(all-the-icons consult corfu dashboard doom-modeline doom-themes esup
                   evil-collection evil-org flycheck-inline general
                   lsp-java lsp-pyright magit marginalia orderless
                   org-bullets org-fragtog org-roam-ui python-black
                   sudo-edit vertico yasnippet-snippets)))
(custom-set-faces
